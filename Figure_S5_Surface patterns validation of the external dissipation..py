...
def causal_record_kernel(t_current, src):
    ...
    return src["force"] * decay * state * H_causal * (beta_field * 1/(1 + r * 0.01))  
...
snap_cross_1d   = []
capture_times   = []
capture_steps = [0, 100, 200, 400, 600]

for step in range(T_steps + 1):
    current_time = step * dt * beta_field[cy, cx] * 1/(1 + step * 0.000)
